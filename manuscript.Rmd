...
We conducted a single centre registry-based retrospective cohort study using data from the trauma register and trauma care quality database at the Karolinska University Hospital trauma center between 2013 and 2023 [@noauthor_undated-xw]. 
...
```
# Label levels
study.sample$pt_Gender <- factor(study.sample$pt_Gender, levels = c("Male", "Female"))
